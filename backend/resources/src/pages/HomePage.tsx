                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div className="flex flex-col gap-6">
                                ...
                                <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
                                    The official platform for managing RUPP
                                    student payments. Easily track tuition,
                                    upload receipts, and get administrative
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-slate-600 dark:text-slate-400">
                                Designed to make university payments simple and
                                secure
                            </p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white dark:bg-[#1a2632] rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
                                ...
                                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                                    Submit your tuition payments with just a few
                                    clicks. Upload receipts and track your
                            ...
                            <div className="bg-white dark:bg-[#1a2632] rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
                                ...
                                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                                    ...
                                    security. All transactions are encrypted and
                                    verified by university staff.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-[#1a2632] rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
                                <div className="size-14 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center mb-6">
                                ...
                                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                                    Get notified instantly when your payment is
                                    approved. No more waiting in long queues or
                                    unclear statuses.
                                </p>
                            </div>
                        </div>
                ...
                <div className="w-full bg-gradient-to-br from-primary to-blue-600 py-16 md:py-20 px-4 md:px-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg md:text-xl text-blue-100 mb-8">
                            Join thousands of RUPP students managing their
